...
tr_loader = DataLoaderWithImages(d.folds["train"], d.item_images, d.u_i_matrix, 64, 64)
val_loader = DataLoaderWithImages(d.folds["val"], d.item_images, d.u_i_matrix, 64, 64, shuffle=False)
# training the model
